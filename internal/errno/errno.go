...
var (
	...
	ERR_GET_HOSTS_FAILED    = EC(110000, "execute SQL failed while get hosts")
	ERR_UPDATE_HOSTS_FAILED = EC(110001, "execute SQL failed while update hosts")
	// 111: database/SQL (execute SQL statement: clusters table)
	ERR_INSERT_CLUSTER_FAILED          = EC(111000, "execute SQL failed while insert cluster")
	ERR_GET_CURRENT_CLUSTER_FAILED     = EC(111001, "execute SQL failed while get current cluster")
	ERR_GET_CLUSTER_BY_NAME_FAILED     = EC(111002, "execute SQL failed while get cluster by name")
	ERR_GET_ALL_CLUSTERS_FAILED        = EC(111003, "execute SQL failed while get all clusters")
	ERR_CHECKOUT_CLUSTER_FAILED        = EC(111004, "execute SQL failed while checkout cluster")
	ERR_DELETE_CLUSTER_FAILED          = EC(111005, "execute SQL failed while delete cluster")
	ERR_UPDATE_CLUSTER_TOPOLOGY_FAILED = EC(111006, "execute SQL failed while update cluster topology")
	ERR_UPDATE_CLUSTER_POOL_FAILED     = EC(111007, "execute SQL failed while update cluster pool")
	// 112: database/SQL (execute SQL statement: containers table)
	ERR_INSERT_SERVICE_CONTAINER_ID_FAILED   = EC(112000, "execute SQL failed while insert service container id")
	ERR_SET_SERVICE_CONTAINER_ID_FAILED      = EC(112001, "execute SQL failed while set service container id")
	ERR_GET_SERVICE_CONTAINER_ID_FAILED      = EC(112002, "execute SQL failed while get service container id")
	ERR_GET_ALL_SERVICES_CONTAINER_ID_FAILED = EC(112003, "execute SQL failed while get all services container id")
	// 113: database/SQL (execute SQL statement: clients table)
	ERR_INSERT_CLIENT_FAILED           = EC(113000, "execute SQL failed while insert client")
	ERR_GET_CLIENT_CONTAINER_ID_FAILED = EC(113001, "execute SQL failed while get client container id")
	ERR_GET_CLIENT_BY_ID_FAILED        = EC(113002, "execute SQL failed while get client by id")
	ERR_GET_ALL_CLIENTS_FAILED         = EC(113003, "execute SQL failed while get all clients")
	ERR_DELETE_CLIENT_FAILED           = EC(113004, "execute SQL failed while delete client")
	// 114: database/SQL (execute SQL statement: playground table)
	ERR_INSERT_PLAYGROUND_FAILED      = EC(114000, "execute SQL failed while insert playground")
	ERR_GET_ALL_PLAYGROUND_FAILED     = EC(114001, "execute SQL failed while get all playgrounds")
	ERR_GET_PLAYGROUND_BY_NAME_FAILED = EC(114002, "execute SQL failed while get playground by name")
	ERR_DELETE_PLAYGROUND_FAILED      = EC(114003, "execute SQL failed while delete playground")
	// 115: database/SQL (execute SQL statement: audit table)
	ERR_GET_AUDIT_LOGS_FAILE = EC(115000, "execute SQL failed while get audit logs")
	...
	ERR_GLOBAL_FIELD_MISSING           = EC(323001, "global field missing")
	ERR_DISK_FIELD_MISSING             = EC(323002, "disk field missing")
	ERR_DEVICE_FIELD_MISSING           = EC(323003, "device field missing")
	ERR_MOUNT_POINT_FIELD_MISSING      = EC(323004, "mount field missing")
	ERR_FORMAT_PERCENT_FIELD_MISSING   = EC(323005, "format_percent field missing")
	ERR_DUPLICATE_DISK                 = EC(323006, "disk is duplicated")
